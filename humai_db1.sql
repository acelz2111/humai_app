...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 18, 2025 at 03:42 AM
...
INSERT INTO `feedback` (`id`, `user_id`, `comments`) VALUES
(1, 1, 'Great platform, very easy to use and intuitive!'),
(2, 2, 'Could use some performance improvements, but works well overall.'),
(3, 3, 'The mobile app version is a bit laggy at times.'),
(4, 4, 'I love how user-friendly everything is. Keep it up!'),
(5, 5, 'I had some trouble uploading images, but the support was helpful.'),
(6, 6, 'Fantastic service, really impressed with the system accuracy.'),
(7, 5, 'I like the design, but I would love more tutorial content.'),
(8, 8, 'Good experience, but it would be nice to have more detailed results.'),
(9, 9, 'Sometimes the system takes too long to diagnose, needs faster processing.'),
(10, 10, 'Very informative platform, I learned a lot about crop diseases!'),
(11, 11, 'The interface is sleek, but it can be difficult to navigate at times.'),
(12, 12, 'I appreciate the system\'s accuracy, it really helped me a lot.'),
(13, 13, 'Could benefit from more customization options for notifications.'),
(14, 14, 'Amazing platform! The analysis and results are spot-on.'),
(15, 18, 'It\'s a great tool, but I think it needs better integration with social media.'),
(16, 16, 'Love the detailed information, but it would be helpful if it could support more diseases.'),
(17, 17, 'Good tool, but I had trouble with the login process initially.'),
(18, 18, 'I would appreciate more prevention tips for different diseases.'),
(19, 10, 'Overall, the platform is easy to use, but the help section could be better.'),
(20, 20, 'I wish the app had a way to track the progress of my crops over time.'),
(21, 21, 'Really easy to use and useful, but it could do with better image recognition.'),
(22, 22, 'I was expecting more information on the diagnosis, but it was still helpful.'),
(23, 23, 'It took me a while to figure out how to upload my data, but once done, it was fine.'),
(24, 24, 'The treatment information provided was very useful, thank you.'),
(25, 26, 'The app needs to be more responsive, but otherwise works well.'),
(26, 26, 'I found the disease explanations really helpful. Would love more detailed notes.'),
(27, 27, 'Good experience, although the system sometimes freezes when uploading large files.'),
(28, 28, 'I appreciate the real-time updates and notifications from the platform.'),
(29, 29, 'It\'s a helpful tool for diagnosing crop diseases, but I would suggest adding more crops.'),
(30, 30, 'The feedback I got was quick and useful, but I hope the system improves over time.');
...
(1, 'UpdatedName', 'UpdatedLastName', 2, 'john.doe1@example.com', 'password123', '1234567890', 'California', '2025-07-14 06:08:48'),
(2, 'Jane', 'Doe', 2, 'jane.doe1@example.com', 'password123', '0987654321', 'Nevada', '2025-07-14 06:08:48'),
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `log_user_registration` AFTER INSERT ON `user` FOR EACH ROW BEGIN
    INSERT INTO logs (user_id, registration_date)
    VALUES (NEW.id, NOW());
END
$$
DELIMITER ;
